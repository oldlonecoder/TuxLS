...
public:
    ...
    static std::string Ansi(Color::Type aColorName);
    static std::string AnsiBack(Color::Type aColorName);
//  static std::string Html(Color::Type aColorName);
    static Color::Type Scan(std::string aName);
    static std::string Name(Color::Type aColorEnum);
...
template<Color::Format> class Attr : public Color
{

};

template<> class CORE_LIB Attr<Color::Format::Ansi256> : public Color
{
public:
    static std::string Fg(Color::Type C);
    static std::string Bg(Color::Type C);
};

inline std::ostream& operator << (std::ostream& stream, Color::Type C)
{
    stream << Attr<Color::Format::Ansi256>::Fg(C);
    return stream;
}


template<> class CORE_LIB Attr<Color::Format::Html> : public Color
{
public:
    static std::string Fg(Color::Type C);
    static std::string Bg(Color::Type C);
...
//inline std::ostream& operator << (std::ostream& stream, Attr<Color::Format::Html>::Type C)
//{
//    stream << Attr<Color::Format::Html>::Fg(C);
//    return stream;
//}
